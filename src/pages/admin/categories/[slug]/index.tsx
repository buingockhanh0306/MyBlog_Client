...
const SlugDetail = () => {
    ...
    const breadCrumb = [{text: t('categoriesManager')+ ' / ', href:'/admin/categories'}, {text: t('editCategory'), isCurrent: true}]
    ...
    return (
        <>
            ...
            <Box padding={{md: '0px', base: '0 10px'}}>
                ...
                >
                    <ButtonOutline text={t('cancel')} isLoading={false}
                                   onClick={() => router.push('/admin/categories/')}/>
                    <ButtonSolid text={t('update')} isLoading={false} onClick={handleUpdateCategory}/>
                </Flex>

            </Box> : <EditCategorySkeleton/>}
        </>
